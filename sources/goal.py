...
class GoalScraper(BaseScraper):
    def __init__(self):
        ...
        # - https://www.goal.com/en/news/title-article/1234567890
        # - https://www.goal.com/en/lists/title-article/1234567890
        article_url_pattern = r"https://www\\.goal\\.com/en/(?:news|lists|teams|competitions)/[a-z0-9-]+/\\d+"
        self.news_sections = [
            '/en/news/', '/en/lists/', '/en/teams/', '/en/competitions/'
        ]
        super().__init__("Goal.com", "https://www.goal.com", article_url_pattern)
    ...
    def _extract_links_with_pagination(self, section_url):
        ...
        while len(links) < self.max_links_to_crawl:
            # Goal.com dùng /page/2, /page/3, etc cho phân trang
